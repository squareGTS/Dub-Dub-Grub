...
struct AlertContext {
    ...
    static let checkedInCount = AlertItem(title: Text("Server Error."),
                                                message: Text("Unable to get the number of people checked into each locaton. Please check your internet connection and try again."),
                                                dismissButton: .default(Text("Ok")))
    ...
    static let noUserRecord = AlertItem(title: Text("No User Record."),
                                                message: Text("You must log into iCloud on your phone in order to utilize Dub Dub Grab's Profile. Please log in on your phone's settings screen."),
                                                dismissButton: .default(Text("Ok")))
